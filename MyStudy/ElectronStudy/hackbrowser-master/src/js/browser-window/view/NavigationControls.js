...
function NavigationControls(hackBrowserWindow) {
    ...
    let registerBtn;
    let loginBtn_submit;
    let registerBtn_submit;
    let logininput_email;
    let registerBtn_submit;
    let loginBtn_submit;
    let registerBtn_submit;
    let loginBtn_submit;
	...
	let init = function() {
        ...
        minBtn = document.getElementById("button-min")
        maxBtn = document.getElementById("button-max")
        closeBtn = document.getElementById("button-close");
        loginBtn = document.getElementById("button-login");
        registerBtn = document.getElementById("button-register");
		attachEventHandlers()
	}
